...
public class TSPBatchTests
{
    ...
    {
    	Domain domain = new TSPDomain(); // TSP
    	Problem problem = new TSPProblem("tsp/berlin52.tsp", "tsp/berlin52.opt.tour");  // Berlin52
