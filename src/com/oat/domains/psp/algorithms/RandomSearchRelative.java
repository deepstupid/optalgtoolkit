 ...
 * </pre>
 */
public class RandomSearchRelative extends GenericRandomSearchAlgorithm<PSPSolution>
{    	
    @Override
	protected PSPSolution generateRandomSolution(Random rand, Problem problem)
	{
    	return PSPUtils.generateRandomRelSolution((PSPProblem)problem, rand);
	}     
    
    @Override
    public String getDetails()
    {
        return "Generats random solutions using relative coordinates";
    }    

    @Override
    public String getName()
    {
        return "Random Search (rel)";
    }
}
