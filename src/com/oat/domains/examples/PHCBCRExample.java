...
import com.oat.domains.bcr.algorithms.ParallelMutationHillClimber;
 ...
 * </pre>
 */
public class PHCBCRExample
{

	
	public static void main(String[] args)
	{
		BCRDomain domain = new BCRDomain();
		AlgorithmExecutor exec = new AlgorithmExecutor();
		exec.setAlgorithm(new ParallelMutationHillClimber());
		exec.setProblem(new BCRProblem("bcr/lippman.dat"));
		...
		System.out.println("Algorithm Configuration: " + exec.getAlgorithm().getConfigurationDetails());		for(RunProbe p : exec.getRunProbes())
		{
