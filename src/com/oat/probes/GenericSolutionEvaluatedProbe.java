...
/**
 * Description: Generic probe that listens to solution evaluations
 *  
 * Date: 03/09/2007<br/>
 ...
 * </pre>
 */
public abstract class GenericSolutionEvaluatedProbe extends RunProbe
	implements SolutionEvaluationListener
{
		...
		throws InitialisationException
	{
		...
		{
			throw new InitialisationException("Unable to remove run proble as listener from problem, does not exist as listener for problem.");
		}
	}
